"""Request access logging for every API call."""
...
# Bodies are truncated to this many bytes in the log; larger bodies would flood
# it (a clinics response can be tens of KB).
MAX_BODY_LOG = 2000


def configure_logging(level: int = logging.INFO) -> None:
    """Set a log format and level on the root logger."""
    logging.basicConfig(
